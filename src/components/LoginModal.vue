  ...
  <div class="login-mask" @click.self="$emit('close')">
    <div class="login-box">
      ...
      <div class="login-content">
        ...
        <svg t="1772200968812"  viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="14933" class="icon icon--48"><path d="M512 64c-89.6 0-172.8 25.6-249.6 76.8-70.4 44.8-128 115.2-166.4 198.4C64 422.4 57.6 512 70.4 601.6 89.6 691.2 128 768 192 832c64 64 140.8 102.4 230.4 121.6 89.6 19.2 179.2 6.4 256-25.6 83.2-32 153.6-89.6 198.4-166.4 57.6-76.8 83.2-160 83.2-249.6 0-121.6-44.8-230.4-134.4-313.6C742.4 108.8 633.6 64 512 64z m0 832c-76.8 0-147.2-25.6-211.2-64-64-44.8-115.2-102.4-140.8-172.8C128 588.8 121.6 512 134.4 435.2c12.8-76.8 51.2-140.8 102.4-198.4 51.2-51.2 121.6-89.6 198.4-102.4 76.8-12.8 153.6-6.4 224 25.6s128 76.8 172.8 140.8c44.8 64 64 134.4 64 211.2 0 102.4-38.4 198.4-115.2 268.8C710.4 857.6 614.4 896 512 896z" p-id="14934"></path><path d="M678.4 294.4L512 460.8 345.6 294.4l-51.2 51.2L460.8 512l-166.4 166.4 51.2 51.2L512 569.6l166.4 166.4 51.2-51.2L569.6 512l166.4-166.4-57.6-51.2z" p-id="14935"></path></svg>
      </button>
