...
const routes = [
  ...
  { path: '/template/:id/upload-guide', name: 'UploadGuide', component: () => import('../views/UploadGuide.vue'), meta: { title: '上传引导' } },
  { path: '/template/:id/upload', name: 'Upload', component: () => import('../views/Upload.vue'), meta: { title: '选择照片' } },
  { path: '/making', name: 'Making', component: () => import('../views/Making.vue'), meta: { title: '制作中' } },
